        ...
        <main className="flex-1 lg:ml-80 min-h-screen px-8 md:px-20 py-24 max-w-6xl">
          ...
          <section id="overview" className="mb-32 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-xl text-slate-600 font-medium leading-relaxed max-w-3xl mb-12">
              This document outlines the comprehensive implementation of the ANC Proposal Engine—a production-grade automation pipeline that transforms the estimation workflow from manual Excel loops to an intelligent, rapid-quote system. All 14 critical issues have been resolved, the system is Docker-deployment ready, and production deployment is immediately available.
            </p>
              ...
              {[
                {
                  ...
                  benefit: "Eliminates 'Google Search' loop for project site details, ensuring structural data matches exact physical coordinates instantly. System extracts venue names, street addresses, cities, and countries from natural language input or uploaded documents."
                },
                {
              ...
              <div>
                ...
                <div className="bg-slate-50 p-8 border border-slate-100 mb-8">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-[#003366] font-black text-lg">✓</span>
                      <span className="text-slate-600 font-medium text-sm">Frontend starts successfully (Next.js)</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-[#003366] font-black text-lg">✓</span>
                      <span className="text-slate-600 font-medium text-sm">Backend starts successfully (FastAPI)</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-[#003366] font-black text-lg">✓</span>
          ...
          <section id="roadmap" className="mb-32 pt-20">
            ...
            <p className="text-slate-600 font-medium max-w-2xl mb-12 text-center md:text-left">
              While Phase 1 is fully operational for estimation speed, the system is architected for enhanced client engagement and broader ANC ecosystem integration.
            </p>
